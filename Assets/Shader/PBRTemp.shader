...
//helper functions
			...
			/*		 SpecularDistribution *= TrowbridgeReitzAnisotropicNormalDistribution(_Anisotropic, NdotH,
					 ...
					 //return float4(float3(1, 1, 1) * specularity, 1);
			}
			ENDCG
		}
	}
